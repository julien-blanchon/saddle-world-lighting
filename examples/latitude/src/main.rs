...
use saddle_world_lighting::{
    CelestialModel, CelestialSettings, LightingCamera, LightingConfig, LightingPlugin,
    SeasonSettings, Sun, Moon,
};
...
fn main() {
    ...
    let lighting_config = LightingConfig {
    ...
    App::new()
        ...
        .add_plugins(DefaultPlugins.set(WindowPlugin {
            primary_window: Some(Window {
                title: "Lighting \u{2014} Latitude".into(),
        ...
        .add_plugins(LightingPlugin::default().with_config(lighting_config))
